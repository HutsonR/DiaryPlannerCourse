...
private class CryptographyManagerImpl : CryptographyManager {
    ...
    private val secretKeyName = "biometric_encryption_key_882281337"
    ...
    private fun getOrCreateSecretKey(): SecretKey {
        ...
        keyStore.getKey(secretKeyName, null)?.let { return it as SecretKey }

        // if you reach here, then a new SecretKey must be generated for that keyName
        val paramsBuilder = KeyGenParameterSpec.Builder(secretKeyName,
